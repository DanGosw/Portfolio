...
<template>
    <div class="m-2 flex h-20 w-auto items-center justify-between rounded-lg bg-purple-300 p-2 dark:bg-slate-900">
            ...
            <div class="flex sm:hidden">
                <div class="relative inline-block">
                    ...
                    <div v-if="isDropdownOpen"
                        ...
                        <div v-for="option in optionsMenu" :key="option.name"
